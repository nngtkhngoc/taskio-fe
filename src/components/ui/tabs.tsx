...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex h-12 items-center justify-center rounded border-2 border-black bg-blue-100 p-1 text-foreground",
        className
      )}
      {...props}
    />
